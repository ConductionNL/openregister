...
class FileSettingsHandlerTest extends TestCase
{
    ...
    /**
     * `batchSize` is bounded on write (WOO-576). A zero or negative value made
     * the cron job extract nothing and then log "no pending files" for a queue
     * that was not empty; an unbounded one let a single tick attempt
