...
class DeleteObjectTest extends TestCase
{
    ...
    public function testDeleteSetsDeletedBySystemWhenNoUser(): void
    {
        ...
        $this->objectEntityMapper->method('findAcrossAllSources')->willReturn($context);
    ...
    public function testDeleteCreatesAuditTrailWhenEnabled(): void
    {
        ...
        $this->objectEntityMapper->method('findAcrossAllSources')->willReturn($context);
        $this->objectEntityMapper->method('update')->willReturn($object);
    ...
    /**
     * delete() returns true when objectEntityMapper->update() returns the entity
    ...
    public function testDeleteObjectCascadesScalarProperty(): void
    {
        ...
        $this->objectEntityMapper->method('update')->willReturn($parentObject);
