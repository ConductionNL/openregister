...
class RegisterOpenRegisterWithDoriathTest extends TestCase {
	...
	private function makeStep(
		...
		return new class($appManager, $appConfig, $credentialsManager, $this->createMock(LoggerInterface::class), $applicationService) extends RegisterOpenRegisterWithDoriath {
