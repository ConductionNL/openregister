...
<!-- Mirrors hydra/openspec/changes/semantic-object-handoff/specs/semantic-object-handoff/spec.md
     1:1 (the cross-app contract, ADR-051). Requirement names and scenarios are kept identical so
     the OR main spec and the hydra contract cannot drift; only this comment and the @e2e lines
     are OR-side additions. Kind contracts (ns#Case, ns#Quote/#Contract/#Invoice field sets) live
     in the hydra change's specs/handoff-contract-case/ and specs/handoff-contract-order-chain/. -->
