...
>
> The normative MUSTs below have been merged into
> `openspec/specs/event-driven-architecture/spec.md` via the
> `lifecycle-notifications-amendments` change (2026-06-10).
> This file remains as the design record; the canonical spec is
> the single source of truth. Do not edit this file to refine
> the lifecycle contract — open a new change against the
