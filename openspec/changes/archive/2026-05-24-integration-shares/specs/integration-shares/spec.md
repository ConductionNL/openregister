...
Surface NC Shares (file/folder shares on object's linked files, public links, federated shares) through the registry with query-time aggregation and revoke action.
