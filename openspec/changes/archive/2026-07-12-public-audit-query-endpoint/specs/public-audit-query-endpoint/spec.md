# public-audit-query-endpoint

OpenRegister exposes a unified, queryable audit trail for all recorded audit entries across all apps, filtered and exportable for compliance evidence and human-oversight accountability.
