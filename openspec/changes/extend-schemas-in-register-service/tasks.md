...
- [x] 8.1 `composer check:strict` passes (PHPCS on all changed files); existing test suite + new section-5 tests pass syntax check; ADR-008 alignment confirmed (controller thin; logic in service/serializer).
