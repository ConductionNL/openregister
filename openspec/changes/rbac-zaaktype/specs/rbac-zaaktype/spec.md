...
- **Open questions**:
  ...
  - Should the permission matrix UI be a standalone page or integrated into the register detail view?
  - Should RBAC policy changes be versioned for rollback capability?
  - How should the register-level default authorization interact with explicit empty authorization blocks on schemas?
