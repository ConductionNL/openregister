...
- [ ] Task 1: Database migration for oc_openregister_actions and oc_openregister_action_logs tables
...
- [ ] Task 2: Action entity and ActionMapper
...
- [ ] Task 3: ActionLog entity and ActionLogMapper
...
- [ ] Task 4: Action lifecycle events (ActionCreatedEvent, ActionUpdatedEvent, ActionDeletedEvent)
...
- [ ] Task 5: ActionService business logic
...
- [ ] Task 6: ActionExecutor for action execution orchestration
...
- [ ] Task 7: ActionListener event handler
...
- [ ] Task 8: ActionsController with CRUD API
...
- [ ] Task 9: ActionScheduleJob for cron-based scheduled actions
...
- [ ] Task 10: ActionRetryJob for failed action retries
...
- [ ] Task 11: Application.php event listener and job registration
...
- [ ] Task 12: Hook-to-Action migration utility
...
- [ ] Task 13: Unit tests for Action entity, mapper, and service
...
- [ ] Task 14: Integration tests with opencatalogi and softwarecatalog
