...
> - launchpad: new change `map-support` proposed at https://codeberg.org/Conduction/launchpad/src/branch/main/openspec/changes/map-support/proposal.md
...
- [x] **REQ-GEO-007 — Multi-layer map views with layer control.** Pure UI feature. Moved to launchpad `map-support`.
...
- [x] **REQ-GEO-013 — Map drawing and geometry editing.** UI-side concern. Moved to a follow-up launchpad `map-drawing-tools` change.
...
| Map widget rendering, base layers, drawing tools, layer control, NLDS styling | launchpad `map-support` |
