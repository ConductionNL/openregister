...
# Dashboard Sidebar Default State

## Purpose

Defines the initial open/closed state of the OpenRegister dashboard's right-hand app sidebar. The dashboard sidebar renders collapsed on initial load so the dashboard's primary content is unobstructed, while remaining fully functional via the standard Nextcloud sidebar toggle. The default applies to the dashboard view only and does not change any other view's sidebar default.

**OpenSpec changes**: [dashboard-sidebar-closed-by-default](../../changes/archive/2026-06-22-dashboard-sidebar-closed-by-default/) _(archived 2026-06-22)_
