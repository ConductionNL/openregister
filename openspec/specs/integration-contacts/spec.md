...
- **WHEN** `ContactsProvider::requiresPermission()` is called
- **THEN** the system MUST return `null` so access inherits from object RBAC and Contacts address book permissions
