...
class RegistersController extends Controller
{
    ...
    public function index(): JSONResponse
    {
        ...
        // Delegate schema expansion and per-schema stats to the service/serializer layer.
        ...
        // If '@self.stats' is requested, attach register-level statistics (objects, logs, files).
