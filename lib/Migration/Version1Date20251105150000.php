    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper
    {
        ...
        if ($schema->hasTable('openregister_agents')) {
            ...
            if (!$table->hasColumn('views')) {
                $table->addColumn('views', Types::TEXT, [
                    'notnull' => false,
                    'default' => null,
            ...
            if (!$table->hasColumn('search_files')) {
                $table->addColumn('search_files', Types::BOOLEAN, [
                    'notnull' => false,
                    'default' => true,
            ...
            if (!$table->hasColumn('search_objects')) {
                $table->addColumn('search_objects', Types::BOOLEAN, [
                    'notnull' => false,
                    'default' => true,
            ...
            if (!$table->hasColumn('invited_users')) {
                $table->addColumn('invited_users', Types::TEXT, [
                    'notnull' => false,
                    'default' => null,
