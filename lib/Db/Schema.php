...
class Schema extends Entity implements JsonSerializable
{
    ...
    /**
     * Whether objects of this schema are append-only (create permitted; update and delete rejected)
     *
     * When true, ObjectService::saveObject() permits INSERT (creation) but rejects UPDATE,
     * and ObjectService::deleteObject() rejects all deletions. Designed for audit records,
     * compliance evidence, and xAPI/cmi5 learning statements that must not be tampered
     * with after initial write.
     *
     * @var boolean
     */
     ...
     *     appendOnly: bool, searchable: bool, updated: null|string, created: null|string,
