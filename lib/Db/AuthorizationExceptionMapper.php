...
class AuthorizationExceptionMapper extends QBMapper
{
    ...
    /**
     * Find all authorization exceptions for a schema
     *
    ...
    public function findBySchema(string $schemaUuid, bool $activeOnly=true): array
    {
        ...
        $qb->select('*')
            ->from($this->getTableName())
            ->where($qb->expr()->eq('schema_uuid', $qb->createNamedParameter($schemaUuid)));
    ...
    /**
     * Find all authorization exceptions for a register
     *
    ...
    public function findByRegister(string $registerUuid, bool $activeOnly=true): array
    {
        ...
        $qb->select('*')
            ->from($this->getTableName())
            ->where($qb->expr()->eq('register_uuid', $qb->createNamedParameter($registerUuid)));
    ...
    /**
     * Find all authorization exceptions for an organization
     *
    ...
    public function findByOrganization(string $organizationUuid, bool $activeOnly=true): array
    {
        ...
        $qb->select('*')
            ->from($this->getTableName())
            ->where($qb->expr()->eq('organization_uuid', $qb->createNamedParameter($organizationUuid)));
    ...
    }//end findByOrganization()


    /**
     * Find all authorization exceptions of a specific type
     *
    ...
    /**
     * Deactivate an authorization exception
     *
     * This method deactivates an authorization exception without deleting it,
     * allowing for audit trails and potential reactivation.
     *
     * @param string $uuid The UUID of the authorization exception to deactivate
     *
     * @throws DoesNotExistException         If no exception is found
     * @throws MultipleObjectsReturnedException If multiple exceptions are found
     *
     * @return AuthorizationException The deactivated authorization exception
     */
    public function deactivateException(string $uuid): AuthorizationException
    {
    ...
    /**
     * Activate an authorization exception
     *
     * This method reactivates a previously deactivated authorization exception.
     *
     * @param string $uuid The UUID of the authorization exception to activate
     *
     * @throws DoesNotExistException         If no exception is found
     * @throws MultipleObjectsReturnedException If multiple exceptions are found
     *
     * @return AuthorizationException The activated authorization exception
     */
    public function activateException(string $uuid): AuthorizationException
    {
        $exception = $this->findByUuid($uuid);
    ...
    /**
     * Delete an authorization exception by UUID
     *
     * @param string $uuid The UUID of the authorization exception to delete
     *
     * @throws DoesNotExistException         If no exception is found
     * @throws MultipleObjectsReturnedException If multiple exceptions are found
     *
     * @return AuthorizationException The deleted authorization exception
     */
    ...
    /**
     * Count authorization exceptions by criteria
     *
