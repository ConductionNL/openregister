 ...
 * Exception thrown when a schema cannot be found by slug or ID
 *
 * Thrown when attempting to access a schema that doesn't exist or the user
 * doesn't have permission to access. Used for error handling in schema operations.
