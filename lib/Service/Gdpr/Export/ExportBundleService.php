...
class ExportBundleService
{
    ...
    public function __construct(
        ...
        // TODO(ADR-047 Phase-1b, DEFERRED): PAdES-LTV signing deferred — the 2026-07-04
        // tc-lib-pdf spike was No-Go (8.65 stubs the B-T timestamp). Interim = SHA-256
        // hash-only (UnsignedPadesSigner). When resumed, implement a real PadesSigner
        // against pyHanko (MIT sidecar, real B-LTA) or a matured tc-lib-pdf; configurable
        // RFC-3161 TSA URL.
