...
class ConfigurationSettingsHandler
{
    ...
    public function getDefaultOrganisationUuid(): ?string
    {
        try {
            ...
            $this->logger->warning('[ConfigurationSettingsHandler] Failed to get default organisation UUID: '.$e->getMessage(), ['file' => __FILE__, 'line' => __LINE__]);
            return null;
        }
    ...
    public function getTenantId(): ?string
    {
        try {
            ...
            $this->logger->warning('[ConfigurationSettingsHandler] Failed to get tenant ID: '.$e->getMessage(), ['file' => __FILE__, 'line' => __LINE__]);
            return null;
        }
    }//end getTenantId()
    ...
    public function setDefaultOrganisationUuid(?string $uuid): void
    {
        try {
            ...
            $this->logger->error('[ConfigurationSettingsHandler] Failed to set default organisation UUID: '.$e->getMessage(), ['file' => __FILE__, 'line' => __LINE__]);
        }
