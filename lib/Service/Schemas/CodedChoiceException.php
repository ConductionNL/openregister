...
/**
 * A code-list declaration the schema save refuses.
 *
...
/**
 * A property whose choices are declared in a way nothing can resolve.
 *
 ...
 * @spec openspec/changes/property-code-list-from-concept-scheme/specs/skos-concept-registers/spec.md
 */
class CodedChoiceException extends PropertyVocabularyException {
	...
	public function __construct(
		string $message,
		string $path = '',
		string $code = 'coded-choice-invalid',
		string $key = 'conceptScheme',
	) {
		parent::__construct(
			message: $message,
			errors: [
