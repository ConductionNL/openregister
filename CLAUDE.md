...
**As of 2026-08-14**: `en.js` holds 2051 keys, `src/` uses all of them, 0 unused, 100 unwrapped literals outstanding. 18 locales at full parity (2051 keys each), 18 in progress.
...
**Every finished locale is key-for-key identical to `en.js`, always.** All 18
...
Add an English string and you translate it or you unwrap it — you do not leave 18
...
- `test:l10n:parity` **passes, and must keep passing.** It gates the 18 finished
  locales at key-for-key parity and reports the 18 in-progress ones as a backlog
