 ...
 *
 */
export function mockDatabaseData(): TDatabase[] {
	return [
		{
 ...
 * @param data
 */
export function mockDatabase(data: TDatabase[] = mockDatabaseData()): TDatabase[] {
	return data.map((item) => new Database(item))
}
