...
/**
 * @spec openspec/specs/mock-registers/spec.md#requirement-brp-mock-register-basisregistratie-personen
 */
 ...
 *
 */
export function mockRegisterData(): TRegister[] {
	return [
		{
 ...
 * @param data
 */
export function mockRegister(data: TRegister[] = mockRegisterData()): TRegister[] {
	return data.map((item) => new Register(item))
}
