...
const router = new Router({
	...
	routes: [
		...
		{ path: '/registers', name: 'registers', component: RegistersIndex },
		{ path: '/registers/:id', component: RegisterDetail },
		{ path: '/schemas', name: 'schemas', component: SchemasIndex },
		{ path: '/schemas/:id', component: SchemaDetails },
		{ path: '/sources', name: 'sources', component: SourcesIndex },
		{ path: '/organisation', name: 'organisation', component: OrganisationsIndex },
		...
		{ path: '/objects', name: 'objects', component: ObjectsIndex },
		...
		{ path: '/tables', name: 'tables', component: SearchIndex },
		{ path: '/chat', name: 'chat', component: ChatIndex },
		{ path: '/files', name: 'files', component: FilesIndex },
		{ path: '/agents', name: 'agents', component: AgentsIndex },
		{ path: '/configurations', name: 'configurations', component: ConfigurationsIndex },
		{ path: '/deleted', name: 'deleted', component: DeletedIndex },
		{ path: '/audit-trails', name: 'audit-trails', component: AuditTrailIndex },
		{ path: '/search-trails', name: 'search-trails', component: SearchTrailIndex },
		{ path: '/webhooks', name: 'webhooks', component: WebhooksIndex },
		{ path: '/webhooks/logs', name: 'webhooks-logs', component: WebhookLogsIndex },
		{ path: '/endpoints', name: 'endpoints', component: EndpointsIndex },
		{ path: '/entities', name: 'entities', component: EntitiesIndex },
		{ path: '/entities/:id', name: 'entityDetails', component: EntityDetail },
		{ path: '/templates', name: 'templates', component: TemplatesIndex },
