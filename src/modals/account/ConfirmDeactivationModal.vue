		...
		<div class="account-section__modal">
			...
			<p>
				{{
					t(
						'openregister',
						'This action will submit a deactivation request to your administrators.',
					)
				}}
			</p>
			<div class="section__field">
				<label for="deactivation-reason">{{
					t('openregister', 'Reason (optional)')
				}}</label>
				<NcTextField
			...
			<div class="section__field">
				<label for="confirm-username">
					{{ t('openregister', 'Type your username to confirm') }}:
