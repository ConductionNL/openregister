...
export default {
	...
	computed: {
		...
		connectionStatusClass() {
			if (!this.solrStats || !this.solrStats.overview || !this.solrStats.available) return 'status-error'
			if (this.solrStats.overview && solrStats.overview.connection_status || 'Unknown' === 'Connected') return 'status-success'
