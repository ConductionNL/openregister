OC.L10N.register(
    ...
    "Object created: %s" : "Object created: %s",
    "Object updated: %s" : "Object updated: %s",
    "Object deleted: %s" : "Object deleted: %s",
    "Register created: %s" : "Register created: %s",
    "Register updated: %s" : "Register updated: %s",
    "Register deleted: %s" : "Register deleted: %s",
    "Schema created: %s" : "Schema created: %s",
    "Schema updated: %s" : "Schema updated: %s",
    "Schema deleted: %s" : "Schema deleted: %s",
    "Object created: {title}" : "Object created: {title}",
    "Object updated: {title}" : "Object updated: {title}",
    "Object deleted: {title}" : "Object deleted: {title}",
    "Register created: {title}" : "Register created: {title}",
    "Register updated: {title}" : "Register updated: {title}",
    "Register deleted: {title}" : "Register deleted: {title}",
    "Schema created: {title}" : "Schema created: {title}",
    "Schema updated: {title}" : "Schema updated: {title}",
    "Schema deleted: {title}" : "Schema deleted: {title}"
},
