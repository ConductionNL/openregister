OC.L10N.register(
    ...
    "Object changes" : "Object wijzigingen",
    "Register changes" : "Register wijzigingen",
    "Schema changes" : "Schema wijzigingen",
    "Object created: %s" : "Object aangemaakt: %s",
    "Object updated: %s" : "Object bijgewerkt: %s",
    "Object deleted: %s" : "Object verwijderd: %s",
    "Register created: %s" : "Register aangemaakt: %s",
    "Register updated: %s" : "Register bijgewerkt: %s",
    "Register deleted: %s" : "Register verwijderd: %s",
    "Schema created: %s" : "Schema aangemaakt: %s",
    "Schema updated: %s" : "Schema bijgewerkt: %s",
    "Schema deleted: %s" : "Schema verwijderd: %s",
    "Object created: {title}" : "Object aangemaakt: {title}",
    "Object updated: {title}" : "Object bijgewerkt: {title}",
    "Object deleted: {title}" : "Object verwijderd: {title}",
    "Register created: {title}" : "Register aangemaakt: {title}",
    "Register updated: {title}" : "Register bijgewerkt: {title}",
    "Register deleted: {title}" : "Register verwijderd: {title}",
    "Schema created: {title}" : "Schema aangemaakt: {title}",
    "Schema updated: {title}" : "Schema bijgewerkt: {title}",
    "Schema deleted: {title}" : "Schema verwijderd: {title}"
},
