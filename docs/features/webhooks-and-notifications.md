...
### Clearing, snoozing and archiving

A dispatched notice carries a read stamp, a subject axis, a snooze and an
archive. It is cleared by the reader opening the work it was about rather than
by dismissing it in the bell, and archiving is never expressed as reading. See
[Object read state](object-read-state.md) for the fields and the four verbs.
