...
sidebar_position: 1
description: OpenRegister's service-oriented architecture with clear separation of concerns
keywords:
  - Open Register
  - Architecture
  - Services
...
- Perform semantic similarity searches using multiple backends
