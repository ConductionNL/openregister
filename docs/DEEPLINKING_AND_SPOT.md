...
```html
// 3:10:src/sidebars/SideBars.vue
    <div>
...
Concrete implementation in `SearchTrailSideBar.vue`:

Build a query from current state (only include active filters):

```js
// 930:947:src/sidebars/logs/SearchTrailSideBar.vue
...
```js
// 960:966:src/sidebars/logs/SearchTrailSideBar.vue
...
```js
// 967:1018:src/sidebars/logs/SearchTrailSideBar.vue
