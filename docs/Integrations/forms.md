...
![forms integration tab active in the OpenRegister integrations view](/screenshots/integrations/forms.png)
...
Provider registered. Wrapping service + link table tracked under [openspec/changes/integration-forms](https://codeberg.org/Conduction/openregister/src/branch/development/openspec/changes/integration-forms).
