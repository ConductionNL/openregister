...
1. **`lib/Service/MagicMapper.php`** - Main MagicMapper service class
2. **`tests/Unit/Service/MagicMapperTest.php`** - Comprehensive unit tests
3. **`examples/magic_mapper_demo.php`** - Demonstration script
4. **`docs/MagicMapper.md`** - This documentation
