...
bundle. So enforcement keys on the existence of `locales/<loc>.json`: the twelve
recorded locales (`tr ca et hr lt lv ro sk sl bg sr rm`) are held to it, the rest are
