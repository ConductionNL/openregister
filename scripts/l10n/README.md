...
bundle. So enforcement keys on the existence of `locales/<loc>.json`: the eleven
recorded locales (`tr ca et hr lt lv ro sk sl bg sr`) are held to it, the rest are
