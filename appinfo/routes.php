...
return [
    ...
    'routes' => [
        ...
        // @spec openspec/changes/integration-deck/tasks.md#task-3 — schema-level sticky default.
        ['name' => 'deckLinks#getDefault', 'url' => '/api/integrations/deck/schemas/{schema}/default',        'verb' => 'GET'],
        ['name' => 'deckLinks#setDefault', 'url' => '/api/integrations/deck/schemas/{schema}/default',        'verb' => 'PUT'],
